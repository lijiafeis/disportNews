...
public class NewsFragment extends Fragment {
	...
	private void setTitleStrip() {
		...
		tabStrip.setBackgroundColor(getActivity().getResources().getColor(R.color.news_bg));
        //设置当前tab页签的下划线颜色
        tabStrip.setTabIndicatorColor(getActivity().getResources().getColor(R.color.news_viewtitle));
